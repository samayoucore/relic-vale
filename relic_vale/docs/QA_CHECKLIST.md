...
| Build repeatability/package audit | Pass | Three complete one-command builds. All final PCKs have the same SHA-256 and 1118 validated entries. PE imports do not include Visual C++ or MinGW builder runtimes. All six `dist/SHA256SUMS.txt` entries match. |
